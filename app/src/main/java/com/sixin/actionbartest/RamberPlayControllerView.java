...
public class RamberPlayControllerView extends FrameLayout{
    ...
    public RamberPlayControllerView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        repeatOffButtonDrawable = resources.getDrawable(R.drawable.ic_repeat_black_none_45dp);
        repeatOneButtonDrawable = resources.getDrawable(R.drawable.ic_repeat_one_black_24dp);
        repeatAllButtonDrawable = resources.getDrawable(R.drawable.ic_repeat_black_45dp);
